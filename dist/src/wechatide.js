...
export async function callWechatide(call) {
    ...
    return new Promise((resolve, reject) => {
        ...
        child.on("close", (code) => {
            ...
            if (code === 0)
                ...
                reject(new Error(stderr.trim() || stdout.trim() || `wechatide exited with code ${code}`));
        });
    });
}
//# sourceMappingURL=wechatide.js.map